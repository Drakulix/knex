...
class TestPOST(object):
    ...
    def test_success_search(self, flask_api_url, session, pytestconfig):
        ...
        for project in results['hits']['hits']:
            print("%s, title: %s, tags: %s" % (project['_id'], project['_source']['title'], ', '.join(map(str, project['_source']['tags']))))
...
class TestGET(object):
    ...
    def test_success_simplesearch(self, flask_api_url, session, pytestconfig):
        ...
        response = session.get(flask_api_url + "/api/projects/search/simple/?q=superawesometitle&sort=desc&offset=0")
        print(response.text)
    ...
    def test_success_tag(self, flask_api_url, session, pytestconfig):
        ...
        response = session.get(flask_api_url + "/api/projects/search/advanced/?q=tags:superawesometag&sort=desc")
    ...
    def test_no_success_tag(self, flask_api_url, session, pytestconfig):
        ...
        response = session.get(flask_api_url + "/api/projects/search/advanced/?q=tags:superawesometitle&sort=desc")
    ...
    def test_success_author(self, flask_api_url, pytestconfig, session):
        ...
        response = session.get(flask_api_url + "/api/projects/search/advanced/?q=authors.name:superawesomeauthor&sort=desc")
