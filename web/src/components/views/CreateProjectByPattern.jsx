      ...
      render() {
          ...
          if (!this.state.site_loaded && this.state.projectID) {
            return ( <
              ...
              <
              div className = "header" > < CircularProgress size = {
                80
              }
              thickness = {
                5
          ...
          if (!this.state.project_exists && this.state.projectID) {
            ...
            return ( <
              ...
              errorText = {
                (this.state.projectInf.title === "") ? this.props.titleErrorText : ""
              }
              /> < /
              div > <
              div className = "row" >
              ...
              errorText = {
                (this.state.date === "") ? this.props.dateErrorText : ""
              }
              /> < /
              div > <
              /div> <
              ...
              style = {
                ...
                statusString.map(item => < MenuItem value = {
                    item.id
                  }
                  primaryText = {
                    item.text
                  ...
                  ChipInputList suggestions = {
                    this.state.suggestedAuthors
                  }
                  onChange = {
                  ...
                  errorText = {
                    (this.state.authors.length === 0) ? this.props.authorsErrorText : ""
                  }
                  /> <
                  div className = "profile-info" > Links < /div> <
                  ChipInputList defaultValue = {
                    this.state.projectInf.url
                  }
                  value = {
                    this.state.projectInf.url
                  }
                  ...
                  errorText = {
                    (this.state.projectInf.description === "") ? this.props.descriptionErrorText : ""
                  }
                  /> <
                  div className = "row"
                  style = {
