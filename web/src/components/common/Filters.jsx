...
const statusString = [{
  id: "0",
  text: <span className="badge badge-success">DONE</span>,
  value: "DONE"
},
{
  id: "1",
  text: <span className="badge badge-info">IN_REVIEW</span>,
  value: "IN_REVIEW"
},
{
  id: "2",
  text: <span className="badge badge-warning">IN_PROGRESS</span>,
  value: "IN_PROGRESS"
},
{
  id: "3",
  ...
  constructor(props) {
    ...
    if (filters.status !== undefined) {
      stateValue = statusString.filter(
        function (stateField) {
          return filters.status === stateField.value
        }
      );
